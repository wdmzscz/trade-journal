...
export function dayResultBgClass(result: DayResult, selected = false): string {
  ...
  switch (result) {
    case 'win':
      return 'bg-emerald-50 text-emerald-700 hover:bg-emerald-100 dark:bg-emerald-950/40 dark:text-emerald-400 dark:hover:bg-emerald-950/70'
    case 'loss':
      return 'bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-950/40 dark:text-red-400 dark:hover:bg-red-950/70'
    case 'breakeven':
      return 'bg-slate-100 text-slate-600 hover:bg-slate-200 dark:bg-surface-800 dark:text-slate-300 dark:hover:bg-surface-700'
    default:
      return 'hover:bg-slate-50 text-slate-700 dark:text-slate-300 dark:hover:bg-surface-800'
  }
}
